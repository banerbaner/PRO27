//submission to whitehatjr PRO27 by rehan siddiqui
...
function draw() {
  ...
  text("Press and hold the mouse to drag the pendulam", 10, 20);
  text("Release the mouse to oscillate the pendulumn", 10, 35);
